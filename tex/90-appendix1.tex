...
\begin{longlisting}
\inputminted[linenos,frame=single]{java}{inc/src/authMessage}
\caption{Код генерации сообщения authnRequest} 
\label{lst:authMessage}
\end{longlisting}

\begin{longlisting}
\inputminted[linenos,frame=single]{java}{inc/src/logoutMessage}
\caption{Код генерации сообщения logoutRequest} 
\label{lst:logoutMessage}
\end{longlisting}

\begin{longlisting}
\inputminted[linenos,frame=single]{java}{inc/src/logoutResponseMessage}
\caption{Код генерации сообщения logoutResponse} 
\label{lst:logoutResponseMessage}
\end{longlisting}
